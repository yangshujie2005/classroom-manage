...
import com.kuafu.web.mapper.BackgroundImageAllMapper;
 ...
 */
@Slf4j
@Service("BackgroundImageAll")
public class BackgroundImageAllServiceImpl extends ServiceImpl<BackgroundImageAllMapper, BackgroundImageAll> implements IBackgroundImageAllService {
@Autowired
private BackgroundImageAllMapper taskInfoAllMapper;


@Override
public List<BackgroundImageAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BackgroundImageAll> queryWrapper) {

        LambdaQueryWrapper<BackgroundImageAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<BackgroundImageAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BackgroundImageAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<BackgroundImageAll> queryWrapper) {
        LambdaQueryWrapper<BackgroundImageAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<BackgroundImageAll> page, PageRequest pageRequest, LambdaQueryWrapper<BackgroundImageAll> queryWrapper) {
