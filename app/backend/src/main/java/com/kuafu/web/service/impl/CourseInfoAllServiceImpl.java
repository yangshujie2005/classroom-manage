...
@Autowired
private CourseInfoAllMapper taskInfoAllMapper;


@Override
public List<CourseInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CourseInfoAll> queryWrapper) {

        LambdaQueryWrapper<CourseInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<CourseInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CourseInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<CourseInfoAll> queryWrapper) {
        LambdaQueryWrapper<CourseInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<CourseInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<CourseInfoAll> queryWrapper) {
