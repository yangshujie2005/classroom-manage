...
import com.kuafu.web.mapper.ClassroomInfoAllMapper;
 ...
 */
@Slf4j
@Service("ClassroomInfoAll")
public class ClassroomInfoAllServiceImpl extends ServiceImpl<ClassroomInfoAllMapper, ClassroomInfoAll> implements IClassroomInfoAllService {
@Autowired
private ClassroomInfoAllMapper taskInfoAllMapper;


@Override
public List<ClassroomInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<ClassroomInfoAll> queryWrapper) {

        LambdaQueryWrapper<ClassroomInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<ClassroomInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<ClassroomInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<ClassroomInfoAll> queryWrapper) {
        LambdaQueryWrapper<ClassroomInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<ClassroomInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<ClassroomInfoAll> queryWrapper) {
