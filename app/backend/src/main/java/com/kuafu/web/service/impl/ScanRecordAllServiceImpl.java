...
@Autowired
private ScanRecordAllMapper taskInfoAllMapper;


@Override
public List<ScanRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<ScanRecordAll> queryWrapper) {

        LambdaQueryWrapper<ScanRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<ScanRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<ScanRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<ScanRecordAll> queryWrapper) {
        LambdaQueryWrapper<ScanRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<ScanRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<ScanRecordAll> queryWrapper) {
