...
import com.kuafu.web.mapper.BookingInfoAllMapper;
 ...
 */
@Slf4j
@Service("BookingInfoAll")
public class BookingInfoAllServiceImpl extends ServiceImpl<BookingInfoAllMapper, BookingInfoAll> implements IBookingInfoAllService {
@Autowired
private BookingInfoAllMapper taskInfoAllMapper;


@Override
public List<BookingInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BookingInfoAll> queryWrapper) {

        LambdaQueryWrapper<BookingInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<BookingInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BookingInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<BookingInfoAll> queryWrapper) {
        LambdaQueryWrapper<BookingInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<BookingInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<BookingInfoAll> queryWrapper) {
