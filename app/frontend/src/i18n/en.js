export default {
    login: {
        ...
        wx_login: "Quick login with wechat",
        wx_app_login: "Quick login with  wechat app",
        ...
        email_format_error: "must email formatter",
        code_length_rule_text: "code length should be 4-6 characters",
        get_code: "code",
        send_code_success: "code send success"
    },
    register: {
        enter_prefix: "enter",
        title: "Sign up",
